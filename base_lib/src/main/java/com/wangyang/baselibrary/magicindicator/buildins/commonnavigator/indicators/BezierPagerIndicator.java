package com.wangyang.baselibrary.magicindicator.buildins.commonnavigator.indicators;
...
import com.wangyang.baselibrary.magicindicator.FragmentContainerHelper;
import com.wangyang.baselibrary.magicindicator.buildins.ArgbEvaluatorHolder;
import com.wangyang.baselibrary.magicindicator.buildins.UIUtil;
import com.wangyang.baselibrary.magicindicator.buildins.commonnavigator.abs.IPagerIndicator;
import com.wangyang.baselibrary.magicindicator.buildins.commonnavigator.model.PositionData;
...
public class BezierPagerIndicator extends View implements IPagerIndicator {
    ...
    private static final String TAG = "BezierPagerIndicator";
    ...
    private void drawBezierCurve(Canvas canvas) {
        mPath.reset();
        float y = getHeight() - mYOffset - mMaxCircleRadius;//圆心
        mPath.moveTo(mRightCircleX, y);
        Log.e(TAG, "drawBezierCurve:y " + y);
        Log.e(TAG, "drawBezierCurve:y " + mYOffset);
        Log.e(TAG, "drawBezierCurve:y " + mMaxCircleRadius);
        mPath.lineTo(mRightCircleX, y - mRightCircleRadius);//顶点
        mPath.quadTo((mRightCircleX + mLeftCircleX) / 2.0f, y, mLeftCircleX, y - mLeftCircleRadius);
        mPath.lineTo(mLeftCircleX, y + mLeftCircleRadius);
        mPath.quadTo((mRightCircleX + mLeftCircleX) / 2.0f, y, mRightCircleX, y + mRightCircleRadius);
        mPath.close();  // 闭合
